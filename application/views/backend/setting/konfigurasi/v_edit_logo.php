...
//Form Open
echo form_open_multipart(base_url('backend/setting/konfigurasi/edit_logo/'), 'class="form-horizontal"');
?>
...
<form action="" method="POST">
    <div class="card-body">
        ...
        <div class="form-group row">
            <label class="col-sm-2 col-form-label">Logo Lama</label>
            <div class="col-sm-6">
                <img src=" <?php echo base_url('assets/backend/img/logo/thumbnail/' . $isi_form->logo) ?>" class="img img-responsive img-thumbnail" width="200" height="200">
            </div>
        </div>
