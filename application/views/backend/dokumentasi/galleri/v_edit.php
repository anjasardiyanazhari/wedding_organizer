...
//Form Open
echo form_open_multipart(base_url('backend/dokumentasi/Galleri/proses_edit/'), 'class="form-horizontal"');
?>
...
<form action="" method="POST">
    <div class="card-body">
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="hidden" name="id_galleri" value="<?php echo $isi_form->id_galleri; ?>">
                <input type="text" class="form-control" name="judul_foto" id="judul_foto" placeholder=" Judul Foto..." value="<?php echo $isi_form->judul_foto; ?>">
            </div>
        </div>
