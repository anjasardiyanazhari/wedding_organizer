...
//Form Open
echo form_open(base_url('backend/data_master/Rekening/proses_add/'), 'class="form-horizontal"');
?>
...
<form action="" method="POST">
    <div class="card-body">
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" name="nama_bank" id="nama_bank" placeholder=" Nama Bank..." value="<?php echo set_value('nama_bank'); ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" name="nomor_rekening" id="nomor_rekening" placeholder=" Nomor Rekening..." value="<?php echo set_value('nomor_rekening'); ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" name="nama_pemilik" id="nama_pemilik" placeholder=" Nama Pemilik Rekening..." value="<?php echo set_value('nama_pemilik'); ?>">
            </div>
        </div>
