...
//Form Open
echo form_open_multipart(base_url('backend/data_master/Fasilitas/proses_edit/'), 'class="form-horizontal"');
?>
    ...
    <div class="card-body">
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                ...
                <input type="text" class="form-control" name="nama_fasilitas" id="nama_fasilitas" placeholder=" Nama Fasilitas..." value="<?php echo $isi_form->nama_fasilitas; ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" name="kode_fasilitas" id="kode_fasilitas" placeholder=" Kode Fasilitas..." value="<?php echo $isi_form->kode_fasilitas; ?>">
            </div>
        </div>
            ...
            <div class="col-sm-6">
                <select name="id_kategori" class="form-control">
                    <?php foreach ($kategori as $isi) { ?>
                        <option value="<?php echo $isi->id_kategori ?>" <?php if ($isi_form->id_kategori == $isi->id_kategori) {
                                                                            echo "selected";
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="number" class="form-control" name="harga" id="harga" placeholder=" Harga Fasilitas..." value="<?php echo $isi_form->harga; ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <textarea class="form-control" rows="3" name="deskripsi" id="deskripsi" placeholder=" Deskripsi Fasilitas..."><?php echo $isi_form->deskripsi; ?></textarea>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <select name="status_fasilitas" id="status_fasilitas" class="form-control">
                    ...
                    <option value="Draft" <?php if ($isi_form->status_fasilitas == "Draft") {
                                                echo "selected";
                                            } ?>>Simpan Ke Draft
                    </option>
                </select>
