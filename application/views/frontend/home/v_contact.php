            ...
            <div class="row">
                ...
                <div class="col-md-6 p-b-30">
                    ...
                    <form action="" method="post">
                        ...
                        <textarea class="dis-block s-text7 size20 bo4 p-l-22 p-r-22 p-t-13 m-b-20" rows="3" name="komentar" id="komentar" placeholder=" Message" required><?php echo set_value('komentar'); ?></textarea>
