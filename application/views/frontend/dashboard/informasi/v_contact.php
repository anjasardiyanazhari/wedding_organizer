        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-9 p-b-50">
                ...
                <div class="body">
                    ...
                    <p>Anda dapat mengirim message Contact Us melalui form berikut</p>
                    ...
                    //Form Open
                    echo form_open(base_url('frontend/dashboard/Contact/proses_add/'), 'class="form-horizontal"');
                    ?>
                    ...
                    <div class="bo9 w-size100 p-l-40 p-r-40 p-t-30 p-b-38 m-t-30 m-r-0 m-l-auto p-lr-15-sm">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="dis-block s-text7 size20 bo4 p-l-22 p-r-22 p-t-13 m-b-20" name="message" id="message" placeholder=" Masukan Message..."><?php echo set_value('message'); ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <button type="submit" class="btn btn-primary" name="submit"><i class="fa fa-save"></i> Send Message</button>
